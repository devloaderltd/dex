...
contract PurDexStakingRewards is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    modifier updateReward(address account) {
        ...
        if (account != address(0)) {
            // Bolt ⚡: Inline earned() calculation to use the cached rewardPerTokenStored
            // instead of calling rewardPerToken() again.
    ...
    // Bolt ⚡: Apply modifiers once here and call internal methods to prevent duplicate checks
