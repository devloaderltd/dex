...
contract PurDexStakingRewards is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    // ⚡ Bolt Optimization: Consolidate modifiers to prevent redundant SLOAD/SSTORE operations.
    // Calling updateReward and nonReentrant once saves significant gas compared to executing them twice (via external calls).
