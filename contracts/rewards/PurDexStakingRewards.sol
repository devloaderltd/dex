...
contract PurDexStakingRewards is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function _rewardPerToken() internal view returns (uint256) {
        ...
        return rewardPerTokenStored +
            (((_lastTimeRewardApplicable() - lastUpdateTime) * rewardRate * 1e18) / _totalSupply);
    }
    ...
    // ⚡ Bolt: Gas Optimization
    // By using internal helper functions _withdraw and _getReward and applying
    // the modifiers (nonReentrant and updateReward) once to the outer exit() function,
    // we prevent redundant state updates and SLOAD/SSTORE operations.
