...
contract PurDexStakingRewards is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    // ⚡ Bolt: Consolidated `withdraw` and `getReward` into internal helpers to avoid double
    // execution of `nonReentrant` and `updateReward` modifiers, and redundant KYC checks.
