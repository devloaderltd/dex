...
contract PurDexStakingRewards is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    modifier updateReward(address account) {
        ...
        if (account != address(0)) {
            // ⚡ Bolt: Use cached rewardPerTokenStored to avoid redundant rewardPerToken() recalculation
    ...
    // ⚡ Bolt: Extract withdraw core logic to prevent redundant modifier execution in exit()
    ...
    // ⚡ Bolt: Extract getReward core logic to prevent redundant modifier execution in exit()
    ...
    // ⚡ Bolt: Apply modifiers once here and call internal functions to avoid double execution
