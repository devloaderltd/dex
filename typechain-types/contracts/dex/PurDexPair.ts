...
export interface PurDexPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface PurDexPair extends BaseContract {
  connect(runner?: ContractRunner | null): PurDexPair;
  waitForDeployment(): Promise<this>;

  interface: PurDexPairInterface;
  ...
  initialize: TypedContractMethod<
    [_factory: AddressLike, _token0: AddressLike, _token1: AddressLike],
    [void],
    "nonpayable"
  >;
