...
export interface IPurDexPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "getReserves"
...
export interface IPurDexPair extends BaseContract {
  connect(runner?: ContractRunner | null): IPurDexPair;
  waitForDeployment(): Promise<this>;

  interface: IPurDexPairInterface;
