...
export interface IPurDexFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface IPurDexFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IPurDexFactory;
  waitForDeployment(): Promise<this>;

  interface: IPurDexFactoryInterface;
